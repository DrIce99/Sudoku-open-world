...
// Modifica respawn per tracciare le morti
...
// Modifica wrongNumber per tracciare gli errori
const originalWrongNumber = wrongNumber;
...
// Modifica showWin per tracciare i sudoku completati
...
setInterval(() => {
    if (worldInitialized && !playerStats.isGuest) savePlayerData();
}, 20000);